    ...
    <div className="container">
      <div className="row mt-4">
        <div className="col-12 col-lg-6">
          <CardStandard
            className="customCard-s"
            title=" Projet Raspberry Pi intégrant un capteur DHT22 de mesure de la
        ...
        <div className="col-12 col-lg-6">
          <CardStandard
            ...
            title="La liste ci-dessous détaille les composants requis pour la mise
